export const BASE_TITLE = "Sharath Kumbar";

export const pages = {
    site: {
      title: "Sharath Kumbar's blogfolio",
      description:
        "Sharath Kumbar's blogfolio — exploring software engineering, scalable systems, and developer experience.",
    },
    home: {
      title: BASE_TITLE,
      heading: "Hi, I'm Sharath",
      description:
